...
```diff
! ** WARNING! PIrANHA v0.2-alpha is a pre-release version of a new release that
...
All code within **PIrANHA v0.2-alpha** repository is available "AS IS" under a generous 3-Clause BSD license. See the [LICENSE](LICENSE) file for more information.
...
- Bagley, J.C. 2019. PIrANHA v0.2-alpha. GitHub repository, Available at: http://github.com/justincbagley/PIrANHA.
...
The DOI for ```PIrANHA```, via [Zenodo](https://zenodo.org), is as follows:  [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.890815.svg)](https://doi.org/10.5281/zenodo.890815). Here are some examples of citing PIrANHA using the DOI: 
  ...
  Bagley, J.C. 2019. PIrANHA v0.2-alpha. GitHub package, Available at: http://doi.org/10.5281/zenodo.596766.
