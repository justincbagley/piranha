...
USAGE="Usage: $(basename $0) [Help: -h help H Help] [Options: -n w m p s V --version] [stdin:] <workingDir> 
 ## Help:
...
VERBOSE_USAGE="Usage: $(basename "$0") [Help: -h help H Help] [Options: -n w m p s] [stdin:] <workingDir> 
 ## Help:
