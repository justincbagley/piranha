...
#---This code was written July 19, 2016 by:        -------------------------------------##
...
#PBS -l nodes=1:ppn=1,pmem=1gb,walltime=168:00:00
#PBS -N Hasemania_RAD_PartitionFinder_run1
#PBS -m abe
...
MY_PATH_TO_PARTITIONFINDER_ON_LINUX=/fslhome/bagle004/bin/PartitionFinderV1.1.1_Mac/PartitionFinder.py	## __PATH NEEDED__: Change the path to PartitionFinder.py listed here to the appropriate path on your machine or supercomputer cluster, if necessary.
