...
Usage="Usage: $(basename "$0") [Help: -h help H Help] [Options: -k o v] workingDir 
 ...
 ## Options:
  ...
  -o   outputFile (def: NULL) send all output to file in workingDir with this name, for
       example, 'output.txt'.
...
MY_FASTA_FILES="$(find . -type f \( -iname \*.fasta -o -iname \*.fas  -o -iname \*.FAS -o -iname \*.FASTA -o -iname \*.fa \))"
(
