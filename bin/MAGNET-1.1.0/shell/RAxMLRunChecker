...
echo "INFO      | $(date) |----------------------------------------------------------------"
echo "INFO      | $(date) | RAxMLRunChecker, v1.3.0 March 2019  (part of PIrANHA v0.2-alpha.2)   "
...
USAGE="Usage: $(basename $0) [OPTION]...
 ...
 in PIrANHA v0.2-alpha.2 (Bagley 2019) is being run, or has completed a run, to estimate maximum-
