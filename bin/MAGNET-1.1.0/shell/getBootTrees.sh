...
echo "INFO      | $(date) |----------------------------------------------------------------"
echo "INFO      | $(date) | getBootTrees, v1.0.0 March 2019  (part of PIrANHA v0.3a1)      "
...
USAGE="Usage: $(basename $0) [OPTION]...
 ...
 in PIrANHA v0.3a1 (Bagley 2019) has been run to estimate maximum-likelihood (ML) gene trees 
