...
echo "INFO      | $(date) |----------------------------------------------------------------"
echo "INFO      | $(date) | getBootTrees, v1.0.1 December 2020  (part of PIrANHA v0.4a4)   "
...
USAGE="Usage: $(basename "$0") [OPTION]...
 ...
 in PIrANHA v0.4a4 (Bagley 2019) has been run to estimate maximum-likelihood (ML) gene trees 
